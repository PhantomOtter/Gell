...
struct Mesh_struct {
	...
	Mesh_struct(float concentration, float Diffusion_dt, float Diffusion_coef, float Decay_rate) {
		...
		Mesh_initialize(concentration, Diffusion_dt, Diffusion_coef, Decay_rate);
	...
	void Mesh_initialize(float concentration, float Diffusion_dt, float Diffusion_coef, float Decay_rate) {
